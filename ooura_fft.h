...
struct OouraFft {
    ...
    inline void cft1st_128_C(float* a) const {
        const int n = 128;
        int j, k1, k2;
    ...
    inline void cftmdl_128_C(float* a) const {
        const int l = 8;
        const int n = 128;
        const int m = 32;
    ...
    inline void rftfsub_128_C(float* a) const {
    ...
    inline void rftbsub_128_C(float* a) const {
        const float* c = rdft_w + 32;
        int j1, j2, k1, k2;
        float wkr, wki, xr, xi, yr, yi;
